  ...
  return (
    <div className="min-h-screen bg-[#f5f9fd] lg:grid lg:grid-cols-[236px_1fr]">
      ...
      <div className="flex min-h-screen min-w-0 flex-col">
        <header className="sticky top-0 z-20 flex h-[72px] items-center gap-4 border-b border-slate-200/80 bg-white/95 px-4 shadow-[0_1px_8px_rgba(15,31,53,0.04)] backdrop-blur sm:px-6">
          <button type="button" aria-label="Menu" className="flex h-10 w-10 items-center justify-center rounded-lg text-xl text-navy-900 hover:bg-slate-100 lg:hidden">☰</button>
