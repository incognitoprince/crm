...
export function OrdersPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-5">
    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      {orders.map(o => <article key={o.id} onClick={() => navigate("/orders/" + o.id)} onKeyDown={e => { if (e.key === "Enter" || e.key === " ") navigate("/orders/" + o.id); }} role="button" tabIndex={0} className="cursor-pointer rounded-xl border border-sand-100 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
