    ...
    <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex flex-col gap-3 md:flex-row md:items-end">
        <label className="flex-1 text-sm">
          <span className="mb-1 block text-xs text-slate-500">Order to bill</span>
        ...
        <button type="button" disabled={!orderId || saving} onClick={() => void generate()} className="rounded-md bg-navy-900 px-4 py-2.5 text-sm font-medium text-white disabled:opacity-50">
