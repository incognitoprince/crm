...
export function OrderDetailPage() {
  ...
  return <div className="mx-auto max-w-5xl space-y-5">
    ...
    <section className="rounded-xl border border-sand-100 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between gap-3"><h4 className="font-semibold text-navy-900">Payment</h4>{balance > 0 && <Link to={"/payments?orderId=" + order.id} className="rounded-md bg-navy-900 px-3 py-2 text-xs font-medium text-white">Record payment</Link>}</div>
